...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    dueSoonAlert: "Book Due Soon",
    dueSoonDesc: "Your borrowed book 'The Great Gatsby' is due in 2 days.",
    holdReadyAlert: "Hold Ready for Pickup",
    holdReadyDesc: "Your reserved copy of 'Clean Code' is waiting at the circulation desk.",
    systemNotice: "System Announcement",
    systemNoticeDesc: "Library circulation desk will be open until 8 PM this Friday.",
  ...
  uz: {
    ...
    allCaughtUp: "Barchasi o'qildi!",
    noNewNotifications: "Hozircha yangi xabarnomalar yo'q.",
    markAllAsRead: "Barchasini o'qilgan deb belgilash",
    dueSoonAlert: "Qaytarish muddati yaqinlashmoqda",
    dueSoonDesc: "'The Great Gatsby' kitobingizni topshirishga 2 kun qoldi.",
    holdReadyAlert: "Kitob olib ketishga tayyor",
    holdReadyDesc: "Siz band qilgan 'Clean Code' kitobingiz ijara stolida kutmoqda.",
    systemNotice: "Tizim e'loni",
    systemNoticeDesc: "Kutubxona ijara stoli juma kuni soat 20:00 gacha xizmat ko'rsatadi.",
  ...
  ru: {
    ...
    noNewNotifications: "Сейчас нет новых уведомлений.",
    markAllAsRead: "Отметить все как прочитанные",
    dueSoonAlert: "Скоро срок возврата",
    dueSoonDesc: "Срок возврата книги 'The Great Gatsby' истекает через 2 дня.",
    holdReadyAlert: "Книга готова к выдаче",
    holdReadyDesc: "Забронированная книга 'Clean Code' ожидает вас на стойке выдачи.",
    systemNotice: "Объявление системы",
    systemNoticeDesc: "Стойка выдачи в эту пятницу работает до 20:00.",
